...
public class Leval_16 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leval16);
        Leval_1 = findViewById(R.id.patasxan_Level_1);
        Leval_1.setOnClickListener(v -> {
            if(patasxaner.madium[3].equals(Leval_1.getText().toString())){
                ...
                Intent intent = new Intent(Leval_16.this, madium.class);
                startActivity(intent);
                UserModel.baler(Leval_16.this);
    ...
    public void info(View view) {
        Intent intent = new Intent(Leval_16.this, zugaheranist_start_patuhan.class);
        startActivity(intent);
    }
