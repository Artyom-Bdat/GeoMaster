...
public class Leavl_19 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leavl19);


        Leval_1 = findViewById(R.id.patasxan_Level_1);
        Leval_1.setOnClickListener(v -> {
            if(patasxaner.hard[0].equals(Leval_1.getText().toString())){
                ...
                Intent intent = new Intent(Leavl_19.this, hard.class);
                startActivity(intent);
                UserModel.baler(Leavl_19.this);
    ...
    public void info(View view) {
        Intent intent = new Intent(Leavl_19.this, burg_makeres.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
    }
