...
public class Leval_24 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leval24);


        Leval_1 = findViewById(R.id.patasxan_Level_1);
        Leval_1.setOnClickListener(v -> {
            if(patasxaner.hard[5].equals(Leval_1.getText().toString())){
                ...
                Intent intent = new Intent(Leval_24.this, hard.class);
                startActivity(intent);
                UserModel.baler(Leval_24.this);
    ...
    public void info(View view) {
        Intent intent = new Intent(Leval_24.this, burg_makeres.class);
        startActivity(intent);
        overridePendingTransition(0, 0);
    }
