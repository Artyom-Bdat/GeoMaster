...
public class Burg_Skoxmnayin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_burg_skoxmnayin);
        ...
        patasxan_inpat.setOnClickListener(v -> {
            if(patasxaner.modek_3d[1].equals(patasxan_inpat.getText().toString())){
                ...
                Intent intent = new Intent(Burg_Skoxmnayin.this, burg_makeres.class);
                startActivity(intent);
                UserModel.baler(Burg_Skoxmnayin.this);
