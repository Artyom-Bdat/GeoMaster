    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pastxan_nerqnadziq.setOnClickListener(v -> {
            if(patasxaner.patasxan[2].equals(pastxan_nerqnadziq.getText().toString())){
                MotionToast.Companion.createToast(qarankyun_nerqnadzigq.this,
                        "Моладец!",
                        "Ответ привилен!",
                        MotionToastStyle.SUCCESS,
                        MotionToast.GRAVITY_BOTTOM,
                        MotionToast.LONG_DURATION,
                        ResourcesCompat.getFont(qarankyun_nerqnadzigq.this, www.sanju.motiontoast.R.font.helveticabold));
