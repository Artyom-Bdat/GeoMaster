...
public class sexan_paragit_act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pastxan_sexan_paragit.setOnClickListener(v -> {
            if(patasxaner.patasxan[8].equals(pastxan_sexan_paragit.getText().toString())){
                MotionToast.Companion.createToast(sexan_paragit_act.this,
                        "Моладец!",
                        "Ответ привилен!",
                        MotionToastStyle.SUCCESS,
                        MotionToast.GRAVITY_BOTTOM,
                        MotionToast.LONG_DURATION,
                        ResourcesCompat.getFont(sexan_paragit_act.this, www.sanju.motiontoast.R.font.helveticabold));
    ...
    public void Click(View view) {
        MediaPlayer mediaPlayer = MediaPlayer.create(sexan_paragit_act.this, R.raw.sexan_paragit);
        mediaPlayer.start();
