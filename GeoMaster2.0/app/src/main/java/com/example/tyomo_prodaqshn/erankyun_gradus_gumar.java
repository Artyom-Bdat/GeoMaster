    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pastxan_gradus_erk.setOnClickListener(v -> {
            if(patasxaner.patasxan[12].equals(pastxan_gradus_erk.getText().toString())){
                MotionToast.Companion.createToast(erankyun_gradus_gumar.this,
                        "Моладец!",
                        "Ответ привилен!",
                        MotionToastStyle.SUCCESS,
                        MotionToast.GRAVITY_BOTTOM,
                        MotionToast.LONG_DURATION,
                        ResourcesCompat.getFont(erankyun_gradus_gumar.this, www.sanju.motiontoast.R.font.helveticabold));
